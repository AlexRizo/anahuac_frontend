    ...
    return (
        <RadioGroup value={ value[0] || null } onValueChange={ handleChange }>
        {
            answers.map((answer, index) => (
                <div 
                    key={ index }
                    className={`flex items-center text-base 2xl:text-lg gap-3 border ${ value[0] === answer.opt ? 'bg-teal-200/60 border-teal-400 text-black' : 'border-transparent text-gray-600'} rounded-xl px-2.5 2xl:px-5 py-1.5 2xl:py-3 transition`}
                >
