export const LecturaProfesorSecundaria = () => {
  return (
    <article className="font-serif">
      <h2 className="text-xl italic text-center">¿DE QUÉ SIRVE UN PROFESOR?</h2>
      <h2 className="text-sm italic text-center">Umberto Eco (mayo de 2007)</h2>
      <br />
      <p>
      ...
      <p>
        ...
        escuela. Los medios de difusión masivos informan sobre muchas cosas y
        ...
        argumentación de lo que aparece en diarios, revistas y televisión. Y
        ...
        errónea del inglés que cada uno cree haber aprendido de la tecnología o
        los dispositivos?
        <br />
        <br />
      </p>
      <p>
        ...
        &quot;casi todo&quot;, salvo cómo buscar, filtrar, seleccionar, aceptar
      ...
      <p>
        ...
        recordar y qué no es un arte <strong>sutil</strong>.
        <br />
        <br />
      </p>
      <p>
