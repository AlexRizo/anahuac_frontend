...
const menu = [
  {
    children: (
      <>
        {" "}
        <House strokeWidth={1.25} /> Dashboard{" "}
      </>
    ),
    path: "/",
  },
  {
    children: (
      <>
        {" "}
        <CalendarDays strokeWidth={1.25} /> Aplicaciones{" "}
      </>
    ),
    path: "/aplicaciones",
  },
  {
    children: (
      <>
        {" "}
        <Users strokeWidth={1.25} /> Aspirantes{" "}
      </>
    ),
    path: "/aspirantes",
  },
  {
    children: (
      <>
        {" "}
        <FileBadge strokeWidth={1.25} /> Resultados{" "}
      </>
    ),
    path: "/resultados",
  },
  {
    children: (
      <>
        {" "}
        <UserCog strokeWidth={1.25} /> Staff{" "}
      </>
    ),
    path: "/staff",
  },
  {
    children: (
      <>
        {" "}
        <Album strokeWidth={1.25} /> Exámenes{" "}
      </>
    ),
    path: "/examenes",
  },
  {
    children: (
      <>
        {" "}
        <ChartBar strokeWidth={1.25} /> Métricas{" "}
      </>
    ),
    path: "/metricas",
  },
    ...
    <div className="bg-[#F6F6F6] min-w-[266px] h-screen p-4 pl-8 flex flex-col justify-between">
      <div>
        ...
        <nav className="flex flex-col items-center justify-center w-full gap-1">
          {menu.map((item, index) => {
            ...
            if (item.path === "/examenes" && user.role === "APPLICATOR_ROLE")
              return;
      ...
      {user.role === "ADMIN_ROLE" && (
        <div className="flex items-center justify-center gap-2">
          <Label htmlFor="system_status">Estado del sistema</Label>
          <Switch
            id="system_status"
            checked={isChecked}
