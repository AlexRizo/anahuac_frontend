        ...
        <Page size="LETTER" style={{ fontSize: 10 }}>
          ...
          >
            ...
            <Text style={{ marginTop: 8 }}>
              ...
              demostraste, las cuales producto de tu esfuerzo, y en el periodo
              que falta para concluir tu primaria, puedes{" "}
              <Text style={{ fontWeight: 600, fontSize: 10 }}>
            ...
            <Text style={{ marginTop: 8 }}>
              ...
              <Text style={{ fontWeight: 600, fontSize: 10 }}>Primaria</Text>,
              una etapa de muchos aprendizajes y logros, no obstante, antes de
              pasar al siguiente nivel educativo, requieres comprometerte a
              reforzar algunas áreas, lo que facilitará tu adactación a la&nbsp;
            ...
            <Text style={{ marginTop: 8 }}>
              ...
              estamos muy contentos que continúes siendo parte de nuestra
              familia Anáhuac, trabajando juntos podemos ayudarte a adquirir las
        ...
        {totalScore >= 500 && (
          <>
            <View style={{ paddingHorizontal: 40 }}>
              ...
              <Text>
                Entrevista con Departamento Psicopedagógico (previa cita)
              </Text>
              ...
              <Text>
                Posteriormente se realizará el Examen de Ubicación de Idiomas y
            ...
            >
              ...
              <Image
                src="/img/pdf/firma-secundaria.jpg"
                style={{ height: 45 }}
              />
              <View
                style={{
